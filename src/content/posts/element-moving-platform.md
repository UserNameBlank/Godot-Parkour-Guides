...
<video style="pointer-events: none;" autoplay loop muted src="../../../public/moving-platform.webm" controls></video>
...
![Der Create Node Button](/moving-platform/create-node-button.png)

Dann erstellst du ein einfaches Node3D Node.

![Node3D Node](/moving-platform/create-node3d.png)

danach änderst du den Name des Nodes auf etwas passendes, wie "Platform",
indem du darauf Doppelt klickst.

![Namen ändern](/moving-platform/rename-node.png)
...
![Ändere Material](/moving-platform/mesh-set-material.png)
...
![Ändere Node-Typ](/moving-platform/change-platform-type.png)

![StaticBody3D auswählen](/moving-platform/select-staticbody.png)

Nun sagt Godot uns freundlicherweise, dass etwas mit unserem
StaticBody3D nicht stimmt.

![Etwas stimmt nicht](/moving-platform/staticbody-error.png)
...
![Wähle CollisionShape3D](/moving-platform/select-collisionshape.png)
...
![Definiere Form](/moving-platform/cs-select-shape.png)

Hier musst du die **Dimensionen** der Box, wie beim Mesh auch, festlegen.

![Lege Dimensionen fest](/moving-platform/cs-edit-shape.png)

So sieht das ganze dann im Editor aus:

![im editor](/moving-platform/show-mesh-n-cs.png)
...
![AnimationPlayer](/moving-platform/add-animationplayer.png)
...
![Erstelle Animation](/moving-platform/create-animation.png)
...
![Ändere die Länge](/moving-platform/animation-duration.png)
...
![Zeige Schlüssel](/moving-platform/show-the-keys.png)
...
![Animation Mitte](/moving-platform/anim-move-to-middle.png)
...
![Neuer Punkt](/moving-platform/anim-create-middle.png)
...
![Skript](/moving-platform/staticbody-add-script.png)
...
![Skript Parameters](/moving-platform/script-creation.png)

Füge im Code-Editor nun diesen Code ein:

![GdScript](/moving-platform/the-script.png)
...
![AnimatableBody3D](/moving-platform/change-type-again.png)

Das war's. Alles sollte nun funktionieren.

<video src="/moving-platform/platform-moving.mp4" autoplay loop></video>
